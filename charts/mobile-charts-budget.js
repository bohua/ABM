define([
    ...
    function nsw(data) {
        ...
        // var budgetPerformance2 = data["Number"];
        // var refreshTime = budgetPerformance2[0]["DateCreated"];
        //
        ...
        for (var i = 0; i < budgetPerformance.length; i++) {
            ...
            facilityName = budgetPerformance[i]["Value"];
            if (lhd === "FW") {
                ...
                formatter: function () {
                    if (this.series.name == 'mapbg' || this.point.value === undefined) {
                        ...
                        return '<span style="padding:10px; display:block; background:#34474f; border-radius:0px; color: #fff">' +
                            this.point.name + '<br>' + 'Var to PAC : ' + this.point.value + '</span>';
                    }
    ...
    function sydney(data) {
        ...
        var chartspacing_bottom = helper.isPortrait() ? 25 : 10;
        var chartspacing_top = helper.isPortrait() ? 10 : 10;
