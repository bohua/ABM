    ...
    return {
        getData: function (data) {
            ...
            for (var i = 0; i < budgetPerformance.length; i++) {
                ...
                if (lhd === "FW") {
                    var fwValue = budgetPerformance[i]["Value"];
                    var fwName = budgetPerformance[i]["LHD"];

                }
                if (lhd === "HNE") {
                    var hneValue = budgetPerformance[i]["Value"];
                    var hneName = budgetPerformance[i]["LHD"];
                }
                if (lhd === "MUR") {
                    var mValue = budgetPerformance[i]["Value"];
                    var mName = budgetPerformance[i]["LHD"];
                }
                if (lhd === "MNC") {
                    var mncValue = budgetPerformance[i]["Value"];
                    var mncName = budgetPerformance[i]["LHD"];
                }
                if (lhd === "NNSW") {
                    var nnswValue = budgetPerformance[i]["Value"];
                    var nnswName = budgetPerformance[i]["LHD"];
                }
                if (lhd === "SNSW") {
                    var snswValue = budgetPerformance[i]["Value"];
                    var snswName = budgetPerformance[i]["LHD"];
                }
                if (lhd === "WNSW") {
                    var wnswValue = budgetPerformance[i]["Value"];
                    var wnswName = budgetPerformance[i]["LHD"];
                }
                if (lhd === "IS") {
                ...
                if (lhd === "SVHN") {
                    var svhnValue = budgetPerformance[i]["Value"];
                    var svhnName = budgetPerformance[i]["LHD"];
                }
                if (lhd === "SCHN") {
                    var schnValue = budgetPerformance[i]["Value"];
                    var schnName = budgetPerformance[i]["LHD"];
                }
            ...
            var yellow = [];
            var red = [];
            var dataColor = [fw, wnsw, snsw, ish, m, hne, nnsw, mnc];
            ...
            var mapformatter = function (key, data, image) {
                ...
                // }
                // else if(key === 'FW') {
                //     return '<span class="datalabel-name" style="color: black">Far West<br><img src="images/'+image+'" width="25"></span>';
                // }
                // else
            ...
            function networks(data, id) {
                if (data > 2) {
                    ...
                    $(id).parent().attr("class", "red2");
                }
                if (data > 0 && data <= 2) {
                    $(id).attr("src", 'images/right-down.png');
                    $(id).parent().attr("class", "yellow2");
                }
                if (data <= 0) {
                    //$(id).attr("src", 'images/green-circ.png');
                    $(id).attr("src", 'images/check.png');
                    $(id).parent().attr("class", "green2");
                }
            }
            ...
            $("#svhns-panel").hover(function () {
                $("#svhns-panel").find(".map-hover").remove();
                $("#svhns-panel").append("<div class='map-hover'>" + title + svhnValue + "</div>");
                $("#svhns-panel").find(".map-hover").fadeOut(2500);
            })

            $("#svhns-panel").mouseleave(function () {
                $("#svhns-panel").find(".map-hover").remove();
                //alert(svhnValue);
            })

            $("#schns-panel").hover(function () {
                $("#schns-panel").find(".map-hover").remove();
                $("#schns-panel").append("<div class='map-hover'>" + title2 + schnValue + "</div>");
                $("#schns-panel").find(".map-hover").fadeOut(2500);
            })

            $("#schns-panel").mouseleave(function () {
                $("#schns-panel").find(".map-hover").remove();
            })
...

                    {
                        ...
                        dataLabels: {
                            ...
                            formatter: function (data) {
                                ...
                                //return mapformatter(this.key, data, "yellow-circ.png")
...

                    {
                        ...
                        dataLabels: {
                            ...
                            formatter: function (data) {
                                ...
                                //return mapformatter(this.key, data, "red-circ.png");
